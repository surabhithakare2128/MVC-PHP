...
<form action="index.php?page=accounts&action=register" method="post">
    <div>
        <label for="registration"><b>First Name:</b></label>
        <input type="text" class="form-control" id="fname"  name="fname" placeholder="Enter First name" required >
    </div><br>

    <div>
        <label for="registration"><b>Last Name:</b></label>
        <input type="text" class="form-control" id="lname"  name="lname" placeholder="Enter Last Name" required >
    </div><br>

    <div>
        <label for="registration"><b>Email Address:</b></label>
        <input type="email" class="form-control" id="ename"  name="email" placeholder="Enter Email Address" required >
    </div><br>

    <div>
        <label for="registration"><b>Phone Number:</b></label>
        <input type="number" class="form-control" id="phone"  name="phone" placeholder="Enter Phone Number" required >
    </div><br>

    <div>
        <label for="registration"><b>Birthday:</b></label>
        <input type="date" class="form-control" id="lname"  name="lname" placeholder="Enter Last Name" required >
    </div><br>

    <div>
        <label for="registration"><b>Gender:</b></label>
